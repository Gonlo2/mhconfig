    ...
    public:
        ...
        VirtualType virtual_type() const {
            switch (tag()) {
                case Tag::NONE:
                    break;
                case Tag::FORMAT: // Fallback
                case Tag::SREF:
                    return VirtualType::LITERAL;
                case Tag::REF: // Fallback
                case Tag::DELETE: // Fallback
                case Tag::OVERRIDE: // Fallback
                case Tag::MERGE:
                    return VirtualType::SPECIAL;
            }

            switch (type()) {
                case Type::UNDEFINED:
                    return VirtualType::UNDEFINED;
                case Type::MAP:
                    return VirtualType::MAP;
                case Type::SEQUENCE:
                    return VirtualType::SEQUENCE;
                case Type::NONE: // Fallback
